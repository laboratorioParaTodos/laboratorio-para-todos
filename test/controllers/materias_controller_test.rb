...
class MateriasControllerTest < ActionController::TestCase
  ...
  test "should create materia" do
    assert_difference('Materia.count') do
      post :create, materia: { carrera_id: @materia.carrera_id, clave: @materia.clave, nombre: @materia.nombre }
    end
  ...
  test "should update materia" do
    patch :update, id: @materia, materia: { carrera_id: @materia.carrera_id, clave: @materia.clave, nombre: @materia.nombre }
    assert_redirected_to materia_path(assigns(:materia))
  end
